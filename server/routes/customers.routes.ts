...
import { addCusotmer, getCustomers } from '@controllers/customers.controller';
...
// router.put('/update-customer/:id', updateVehicle);

// // DELETE /customers/delete-customer/:id - Soft delete customer
// router.delete('/delete-customer/:id', deleteVehicle);
